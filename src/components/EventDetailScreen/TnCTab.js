    ...
    return (
        <View style={{ marginHorizontal: 15 }}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 100}}>
                            ...
                            clubRules.map((item) => {
                                return (
                                    <View key={item.id} style={{ marginBottom: 10 }}>
                                        <Text style={{ color: '#fff', fontSize: 16, fontFamily: 'Blinker' }}>{`\u25CF ${item.rule}`}</Text>
                                    </View>
                                )
                            })
                        }
                ...
                <View style={{ borderColor: '#fff', borderRadius: 15, borderWidth: 1, marginVertical: 15 }}>
                    <Text style={{ fontFamily: 'Montserrat-Bold', color: '#fff', margin: 10, fontSize: 18 }}>By Let's Beano</Text>
                    <View style={{ margin: 10 }}>
                        {/* <Text style={{ color: '#fff', fontSize: 16, fontFamily: 'Blinker' }}>{`\u2022 hi`}</Text> */}
                        {
                            beanoRules.map((item) => {
