    ...
    return (
        ...
        >
            <View style={styles.container}>
                <View style={{ width: '100%', borderColor: '#fff', borderRadius: 15, borderWidth: 1, marginTop: 20 }}>
                    <Text style={{ color: '#fff', fontFamily: 'Montserrat-Bold', fontSize: 20, marginHorizontal: 20, marginTop: 10 }}>User Ratings</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', marginTop: 10, marginHorizontal: 15 }}>
                ...
                <Text style={{ color: '#fff', fontFamily: 'Montserrat-Bold', fontSize: 20, marginTop: 10 }}>Reviews</Text>
