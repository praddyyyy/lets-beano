...
const RatingProgress = (props) => {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
            <View style={{ width: 80 }}>
                <Text style={{ color: '#fff', marginRight: 20, fontFamily: 'Blinker_400Regular' }}>{description}</Text>
            </View>
            ...
            <View style={{ width: 40 }}>
                <Text style={{ color: '#fff', fontFamily: 'Blinker_400Regular' }}>{Math.round((rating * 100).toFixed(1))}%</Text>
            </View>
        </View>
    )
}
