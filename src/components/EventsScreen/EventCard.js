        ...
        <View style={{ marginVertical: 15, marginRight: 20 }}>
            ...
            <TouchableOpacity onPress={pressHandler}>
                <View style={{ borderRadius: 15, height: 250, width: 170 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#1f1f1f', height: '100%', flex: 1, borderBottomLeftRadius: 15, borderBottomRightRadius: 15 }}>
                        ...
                        <Text style={{ color: '#fff', marginLeft: 10, fontFamily: 'Montserrat-SemiBold', fontSize: 12 }}>Sun, 20 Nov</Text>
                        <View style={{ borderRadius: 50, backgroundColor: '#000', marginRight: 10 }}>
                            <Text style={{ color: '#fff', paddingHorizontal: 10, paddingVertical: 5, fontFamily: 'Montserrat-SemiBold', fontSize: 10 }}>12.3 Km</Text>
                        </View>
                    </View>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={pressHandler}>
                <View style={{ marginTop: 5 }}>
                    ...
                    <Text style={{ color: '#fff', fontFamily: 'Montserrat-SemiBold', fontSize: 15 }}>{eventName}</Text>
                    <Text style={{ color: '#fff', fontFamily: 'Montserrat', paddingVertical: 5, fontSize: 13 }}>{eventAddress}</Text>
                    <Text style={{ color: '#fff', fontFamily: 'Montserrat', fontSize: 12 }}>{eventPrice} onwards</Text>
                </View>
            </TouchableOpacity>
        </View >
    )
