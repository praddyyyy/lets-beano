            ...
            <View style={{ width: '100%', backgroundColor: '#1f1f1f', top: 0, height: index == 1 ? 60 : 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 15 }}>
                    <TouchableOpacity onPress={() => navigation.goBack()}>
                        <Icon type={Icons.Ionicons} name='chevron-back-circle' color='white' size={Dimensions.SCREEN_HEIGHT * 0.035} style={{ marginRight: 5 }} />
                    </TouchableOpacity>
                    <Text style={{ fontFamily: 'Montserrat-SemiBold', color: '#fff' }}>{clubName}</Text>
                </View>
